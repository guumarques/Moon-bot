...
public class MemberCounter extends ListenerAdapter {
    ...
    public void onReady(ReadyEvent event) {
        Guild guild = event.getJDA().getGuildById("1223392724497993778");
        channel = guild.getTextChannelById("1223664906138816703");
        updateMemberCount();
    }
    ...
    private void updateMemberCount() {
        int memberCount = channel.getGuild().getMemberCount();
